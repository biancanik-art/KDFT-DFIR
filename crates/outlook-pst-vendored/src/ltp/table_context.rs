...
impl TableContextInfo {
    pub fn new(
        ...
        if end_4byte_values < 8 || end_4byte_values % 4 != 0 {
            ...
            match (column.prop_type(), column.offset()) {
                ...
                (PropertyType::Integer16, offset)
                    if offset % 2 == 0
                        ...
                        && offset <= end_2byte_values.saturating_sub(2) => {}
                (
                    PropertyType::Integer32
                    | PropertyType::Floating32
                    | PropertyType::ErrorCode
                    ...
                    | PropertyType::MultipleBinary,
                    offset,
                ) if offset % 4 == 0 && offset <= end_4byte_values.saturating_sub(4) => {}
                (
                    PropertyType::Floating64
                    | PropertyType::Currency
                    | PropertyType::FloatingTime
                    ...
                    | PropertyType::Time,
                    offset,
                ) if offset % 4 == 0 && offset <= end_4byte_values.saturating_sub(8) => {}
                (_, offset) => {
        ...
        if !has_row_version {
            return Err(LtpError::TableContextRowVersionColumnNotFound);
        }
