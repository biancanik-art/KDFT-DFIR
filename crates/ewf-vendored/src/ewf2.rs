...
impl Ewf2FileHeader {
    pub fn parse(buf: &[u8]) -> Result<Self> {
        ...
        let segment_number = u32::from_le_bytes([buf[12], buf[13], buf[14], buf[15]]);
...
impl Ewf2SectionDescriptor {
    pub fn parse(buf: &[u8], offset: u64) -> Result<Self> {
        ...
        let section_type =
            Ewf2SectionType::from_u32(u32::from_le_bytes([buf[0], buf[1], buf[2], buf[3]]));
        let data_flags = u32::from_le_bytes([buf[4], buf[5], buf[6], buf[7]]);
        ...
        let descriptor_size = u32::from_le_bytes([buf[24], buf[25], buf[26], buf[27]]);
        let padding_size = u32::from_le_bytes([buf[28], buf[29], buf[30], buf[31]]);
...
impl Ewf2TableEntry {
    pub fn parse(buf: &[u8]) -> Result<Self> {
        ...
        Ok(Self {
            ...
            chunk_data_size: u32::from_le_bytes([buf[8], buf[9], buf[10], buf[11]]),
