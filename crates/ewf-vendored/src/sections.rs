...
impl EwfVolume {
    ...
    pub fn chunk_size(&self) -> Result<u64> {
        u64::from(self.sectors_per_chunk)
            ...
            .ok_or_else(|| EwfError::Parse("EWF volume chunk size overflow".to_string()))
    }
    ...
    pub fn total_size(&self) -> Result<u64> {
        u64::from(self.bytes_per_sector)
            ...
            .ok_or_else(|| EwfError::Parse("EWF volume byte length overflow".to_string()))
    }
}
...
pub(crate) struct Chunk {
    ...
    /// Whether this chunk uses compression or pattern fill.
    pub(crate) compressed: bool,
    /// The actual on-disk encoding. EWF2 chooses this in the segment header.
    pub(crate) encoding: ChunkEncoding,
    /// EWF2 raw chunks can carry a trailing Adler-32 checksum.
